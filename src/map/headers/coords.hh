...
enum class CornerEdgeDirection {
  RIGHT = 0,
  BOTTOM_RIGHT,
  BOTTOM_LEFT,
  LEFT,
...
const std::vector<std::vector<CornerEdgeDirection>>
    CORNER_TO_EDGE_DIRECTION_MAPPING{
...
// same way Same as BOTTOM_RIGHT, LEFT and TOP_RIGHT
const std::vector<std::vector<CornerEdgeDirection>>
    EDGE_TO_CORNER_DIRECTION_MAPPING{
...
const std::vector<HexCornerDirection> HEX_CORNER_DIRECTIONS{
    HexCornerDirection::RIGHT,       HexCornerDirection::BOTTOM_RIGHT,
    HexCornerDirection::BOTTOM_LEFT, HexCornerDirection::LEFT,
    HexCornerDirection::TOP_LEFT,    HexCornerDirection::TOP_RIGHT,
};
